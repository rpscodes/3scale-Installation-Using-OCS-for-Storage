...
+
image::images/terminal-3.gif[cli]
...
. From the OpenShift Admin Console, navigate to Operators > OperatorHub > Type Container Storage in the search box and click on the OpenShift Container Storage Operator and Install.
